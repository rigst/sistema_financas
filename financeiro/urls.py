...
urlpatterns = [
    ...
    path(
        "receitas/<int:pk>/receber/", views.receita_marcar_recebida, name="receita_marcar_recebida"
    ),
    path(
        "receitas/<int:pk>/desmarcar-recebida/",
        views.receita_desmarcar_recebida,
        name="receita_desmarcar_recebida",
    ),
    ...
    path(
        "despesas/<int:pk>/desmarcar-paga/",
        views.despesa_desmarcar_paga,
        name="despesa_desmarcar_paga",
    ),
    path("despesas/<int:pk>/cancelar/", views.despesa_cancelar, name="despesa_cancelar"),
    path("despesas/compartilhadas/", views.despesas_compartilhadas, name="despesas_compartilhadas"),
    path(
        "despesas/compartilhadas/<int:pk>/aceitar/",
        views.despesa_compartilhada_aceitar,
        name="despesa_compartilhada_aceitar",
    ),
    path(
        "despesas/compartilhadas/<int:pk>/recusar/",
        views.despesa_compartilhada_recusar,
        name="despesa_compartilhada_recusar",
    ),
    path(
        "despesas/compartilhadas/<int:pk>/confirmar-ressarcimento/",
        views.despesa_compartilhada_confirmar_ressarcimento,
        name="despesa_compartilhada_confirmar_ressarcimento",
    ),
    ...
    path("controle/reservas/<int:pk>/excluir/", views.reserva_excluir, name="reserva_excluir"),
]
