...
from core.testing import SENHA_ERRADA
...
def test_paginas_legais_nao_exigem_login(live_server, page):
    ...
    for tipo in (TipoDocumento.TERMOS, TipoDocumento.PRIVACIDADE):
        ...
        # `publicar()` é o que gera o corpo_html sanitizado e põe o documento
        # em vigor; criar com status=publicado deixaria a página em branco.
        documento.publicar()
