...
# WorkingDirectory, que é /var/www/sistema_financas/current.
#
...
# mesmo seria `/run/sistema_financas/gunicorn.ctl` com `RuntimeDirectory=` na unidade,
...
# resolvido na subida.
control_socket = "/home/rod/.gunicorn/sistema_financas.ctl"
